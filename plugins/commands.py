...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('💎️ GROUP 💎️', url='https://t.me/+Q_L0u9Drex1lNDg1')
                ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton('👑️ Main Channel 👑️', url="https://t.me/Request_Movies_Updates"
                )
            ]
        ]
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("JOIN", url="https://t.me/Request_Movies_Updates")
                         ]
                        ]
                    )
                )
